...
const AlbumCard: React.FC<AlbumCardProps> = ({ item }) => {
    return (
        <div className='flex flex-col gap-1 items-center rounded-lg p-4 w-[256px] h-[308px] md:w-[204px] md:h-[256px] cursor-pointer transition-all hover:bg-[#1E1E1E] active:bg-[#1E1E1E]'>
